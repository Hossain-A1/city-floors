...
const ImageHeroSection = () => {
  return (
    <div className='contrainer sp'>
      <div className='flex items-center justify-center max-md:flex-col gap-5 lg:h-[26rem] xl:h-[30rem] md:h-[20rem] h-full w-full overflow-hidden'>
        <div className=' left h-full w-full border-4 border-orange border-opacity-5 relative z-20'>
          <Image
          ...
          />
          <div className='absolute top-5 left-5 right-0 bottom-0 z-10 space-y-2.5'>
        ...
        <div className='middle flex flex-col items-center justify-between gap-5 h-full w-full  '>
          <div className='lg:h-[12rem] xl:h-[14rem] h-full w-full border-4 border-blue border-opacity-5'>
            <Image
          ...
          <div className='lg:h-[12rem] xl:h-[14rem] h-full w-full border-4 border-orange border-opacity-5'>
            <Image
        ...
        <div className='right flex flex-col gap-5 h-full lg:w-[50rem] w-full'>
          <div className='lg:h-[8rem] xl:h-[10rem] h-full w-full border-4 border-dark border-opacity-5'>
            <Image
          ...
          <div className='lg:h-[18rem] xl:h-[20rem] h-full w-full border-4 border-blue border-opacity-5'>
            <Image
